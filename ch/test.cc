...
int main(int, char** argv)
{
    ...
    pqxx::result R = T.exec("SELECT source, destination, longueur, categorie1 FROM edge_paris_export LIMIT 5000");
...
*/
    ...
    std::ifstream ifile("graph_std_bin");
    ...
    std::ifstream ifile2("graph_std_bin_compressed");
...
*/
    ...
    for(int i = 0; i < 100; i++)
    {
        ...
        float cost = query_mono<2>(start, dest, g0); 
        if(cost > d[dest] + 0.1)
