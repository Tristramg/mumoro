		...
		function(data)
		{
			...
			else
			{
				...
				$.each(data.objectives, function(key, val){$("#path_costs tr").append(
										"<td><span class='tableDes'>"+val+"</span></td>"
									);});
...
function showDescription() {
	$("#routing_description").html(
	"<table><caption><span class='tableDes'>Routing description:</span></caption><thread><tr><td><span class='tableDes'>Transport mean</span></td><td><span class='tableDes'>Color<span class='tableDes'></td></tr></thread><tbody><tr><td><span class='tableDes'>Foot</span></td><td><img src='img/desc.foot.png'/></td></tr><tr><td><span class='tableDes'>Public bike</span></td><td><img src='img/desc.bike.png'/></td></tr><tr><td><span class='tableDes'>Car</span></td><td><img src='img/desc.car.png'/></td></tr><tr><td><span class='tableDes'>Municipal transports</span></td><td><img src='img/desc.municipal.png'/></td></tr><tr><td><span class='tableDes'>Connection</span></td><td><img src='img/desc.connection.png'/></td></tr></tbody></table>"
);
}
