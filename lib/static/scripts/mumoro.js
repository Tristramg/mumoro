...
function init() {
	...
	iconStandard.graphicWidth = 25;
	iconStandard.graphicHeight = 35;
	iconStandard.graphicXOffset = -2; 
	...
	iconDepart.externalGraphic = "img/arrow-green.png";
	iconArrivee = OpenLayers.Util.extend({}, iconStandard);
	iconArrivee.externalGraphic = "img/arrow-finish.png";*/
				...
				if( data[0] == null ) {
					...
					if(nodes['start'] && nodes['dest'])
					{
						...
						function(data)
						{
							...
							{
								$("#hash_url").html(
								"<span>Send this url to a friend : </br><span class=\"tinyText\">" +
								hurl + "h?id="+data.h+"</span></span>"
								);	
							}
						});
					}
