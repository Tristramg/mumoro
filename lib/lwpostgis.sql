-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- 
-- $Id: lwpostgis.sql.in 3303 2008-11-20 10:10:11Z mcayland $
--
...
CREATE OR REPLACE FUNCTION postgis_scripts_build_date() RETURNS text
        AS 'SELECT ''2009-12-23 14:16:56''::text AS version'
        LANGUAGE 'sql' IMMUTABLE;
...
CREATE OR REPLACE FUNCTION ST_SimplifyPreserveTopology(geometry, float8)
    RETURNS geometry
    AS '/usr/lib/postgresql/8.3/lib/liblwgeom','topologypreservesimplify'
    LANGUAGE 'C' IMMUTABLE STRICT; -- WITH (isstrict,iscachable);
...
CREATE OR REPLACE FUNCTION _ST_DWithin(geometry,geometry,float8)
    RETURNS boolean
    AS '/usr/lib/postgresql/8.3/lib/liblwgeom', 'LWGEOM_dwithin'
    LANGUAGE 'C' IMMUTABLE STRICT; -- WITH (isstrict,iscachable);
...
CREATE OR REPLACE FUNCTION _ST_CoveredBy(geometry,geometry)
   RETURNS boolean
   AS '/usr/lib/postgresql/8.3/lib/liblwgeom', 'coveredby'
   LANGUAGE 'C' IMMUTABLE STRICT; -- WITH (isstrict,iscachable);
...
CREATE OR REPLACE FUNCTION _ST_Covers(geometry,geometry)
   RETURNS boolean
   AS '/usr/lib/postgresql/8.3/lib/liblwgeom', 'covers'
   LANGUAGE 'C' IMMUTABLE STRICT; -- WITH (isstrict,iscachable);
...
CREATE OR REPLACE FUNCTION _ST_ContainsProperly(geometry,geometry)
    RETURNS boolean
    AS '/usr/lib/postgresql/8.3/lib/liblwgeom','containsproperly'
    LANGUAGE 'C' IMMUTABLE STRICT; -- WITH (isstrict,iscachable);
...
CREATE OR REPLACE FUNCTION _ST_AsGeoJson(int4, geometry, int4, int4)
        RETURNS TEXT
        AS '/usr/lib/postgresql/8.3/lib/liblwgeom','LWGEOM_asGeoJson'
        LANGUAGE 'C' IMMUTABLE STRICT; -- WITH (isstrict,iscachable);
