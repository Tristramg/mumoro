...
#-----------------------------------------------------
osm_california = import_street_data("/home/ody/Developement/mumoro/sf.osm")
...
bart_sf_data = import_gtfs_data( '/home/ody/Developement/mumoro/sf.bart.zip', 'San Fransisco BART' )
muni_sf_data = import_gtfs_data( '/home/ody/Developement/mumoro/sf.muni.zip', 'San Fransisco Municipal' )
...
muni_sf = public_transport_layer( data = muni_sf_data, name = 'Municipal', color = '#817339' )

paths( foot_california, foot_california, [ mode_change, line_change ] )
paths( car_california, car_california, [ dist ] )
...
#----------------------------------------
connect_layers_on_nearest_nodes( bart_sf, foot_california, cost1 )
