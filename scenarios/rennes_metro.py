...
#------------------------------------------------------------------------------------------------------------------
#data_bike = import_bike_service('http://data.keolis-rennes.com/xml/?version=1.0&key=6D0RGK6K94FYNI6&cmd=getstation&param[request]=all',  'Le velo STAR')
...
metro_layer = public_transport_layer(data=metro_data ,name='Metro', color='#AA55AA' )
